...
export function StudentStatusCard({ student, onStatusUpdate }: StudentStatusCardProps) {
            ...
            <div className="p-6">
                <div className="flex items-start space-x-4">
                    ...
                    <div className="relative">
                        ...
                        <div className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-lg shadow-lg flex items-center justify-center bg-${currentStatus.color}-50 border-2 border-white`}>
                            <currentStatus.icon className={`w-3 h-3 text-${currentStatus.color}-600`} />
                        </div>
                    </div>
                    ...
                    <div className="flex-1">
                        <div className="flex items-center justify-between">
                            ...
                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-${currentStatus.color}-50 text-${currentStatus.color}-700`}>
                                {currentStatus.label}
                            </span>
                        </div>
