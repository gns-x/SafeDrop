...
export const PickupAnalyticsChart: React.FC = () => {
  const [metrics] = useState<PickupMetrics>({
    totalPickups: 1247,
    activePickups: 89,
        ...
        <div className="flex items-center justify-center space-x-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Comprehensive pickup operations and performance insights
            </p>
          </div>
        </div>
      </motion.div>
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Tooltip
                  formatter={(value, name) => [value, "Pickups"]} // eslint-disable-line @typescript-eslint/no-unused-vars
                  contentStyle={{
                    backgroundColor: "white",
                    border: "1px solid #e5e7eb",
                    borderRadius: "12px",
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Real-time pickup operations dashboard
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Generate pickup operations report
                </p>
              </div>
            </div>
          </CardContent>
