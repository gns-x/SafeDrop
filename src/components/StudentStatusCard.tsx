...
export default function StudentStatusCard({ student, onStatusUpdate }: StudentStatusCardProps) {
            ...
            <div className="p-6">
                <div className="flex items-center space-x-4">
                    <div className="relative">
                        ...
                        <div className={`absolute -top-2 -right-2 w-6 h-6 rounded-full ${statusInfo.badge} ring-2 ring-white flex items-center justify-center`}>
                            {statusInfo.icon}
                        </div>
                    </div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                    <div className="flex items-center justify-between">
                        <span className={`inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-sm font-medium ${statusInfo.color}`}>
                            {statusInfo.icon}
