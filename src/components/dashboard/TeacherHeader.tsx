...
export function TeacherHeader({ userName, activeStudentsCount, onLogout }: TeacherHeaderProps) {
    return (
                        ...
                        <div className="flex items-center space-x-4">
                            {activeStudentsCount > 0 && (
                                <div className="flex items-center space-x-2 px-4 py-2.5 bg-amber-50 text-amber-700 rounded-xl border border-amber-100">
                                    ...
                                    <span className="font-medium">{activeStudentsCount} active pickups</span>
                                </div>
                            )}
                            <button
                                onClick={onLogout}
