  ...
  const systemMetrics = [
    {
      ...
      metrics: [
        {
          label: "Connections",
          value: `${stats.systemHealth.database.connections.active}/${stats.systemHealth.database.connections.total}`,
        },
    ...
    },
    {
      ...
      metrics: [
        {
          label: "Used",
          value: formatMemory(stats.systemHealth.memory.heapUsed),
        },
        {
          label: "Total",
          value: formatMemory(stats.systemHealth.memory.heapTotal),
        },
      ],
    },
    {
      ...
      metrics: [
        ...
        {
          label: "External",
          value: formatMemory(stats.systemHealth.memory.external),
        },
      ],
    },
  ];
          ...
          >
            <Card variant="glass" className="h-full">
              ...
              <CardContent>
                ...
                <button
                  className={`w-full px-4 py-3 text-white rounded-xl font-medium transition-all duration-200 transform hover:scale-105 ${action.actionColor}`}
                >
                  {action.action}
                </button>
              </CardContent>
