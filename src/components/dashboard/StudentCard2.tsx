...
import { MapPin, Bell, Loader2, GraduationCap, Clock, BookOpen, Award, CheckCircle } from 'lucide-react';
            ...
            <div className="relative p-6">
                <div className="absolute top-4 right-4">
                    <div className={`flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                        isWithinRange ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'
                    }`}>
