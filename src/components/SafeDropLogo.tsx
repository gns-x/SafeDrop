  ...
  return (
    <div className={`inline-flex items-center gap-6 ${className}`}>
      ...
      <div className="relative group">
        <div
          className={`${sizes[size]} aspect-square relative transform transition-all duration-500 group-hover:scale-105`}
        >
          {/* Background Glow */}
      ...
      {showText && (
        <div className="flex flex-col">
          <h1
            className={`font-bold text-blue-900 tracking-tight leading-none
